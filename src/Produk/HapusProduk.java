...
public class HapusProduk extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtProduk.setBorder(javax.swing.BorderFactory.createTitledBorder("Produk Yang Dipilih"));
    ...
    private void tableDataMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableDataMouseClicked
        ...
        txtProduk.setText(tableData.getValueAt(tableData.rowAtPoint(evt.getPoint()), 1).toString());
        txtID.setText(tableData.getValueAt(tableData.rowAtPoint(evt.getPoint()), 0).toString());
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        int confirm = JOptionPane.showConfirmDialog(this, "Yakin hapus pelanggan " + txtProduk.getText() + "?");
        if (confirm == JOptionPane.YES_OPTION) {
            try {
                sql = "DELETE FROM tb_produk WHERE nama_produk='" + txtProduk.getText() + "'";
