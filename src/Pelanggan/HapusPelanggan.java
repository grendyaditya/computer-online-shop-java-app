...
public class HapusPelanggan extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Hapus Pelanggan");
        ...
        txtNama.setBorder(javax.swing.BorderFactory.createTitledBorder("Nama pelanggan yang dipilih"));
    ...
    private void tableDataMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableDataMouseClicked
        ...
        txtNama.setText(tableData.getValueAt(tableData.rowAtPoint(evt.getPoint()), 1).toString());
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        int confirm = JOptionPane.showConfirmDialog(this, "Yakin hapus pelanggan " + txtNama.getText() + "?");
        if (confirm == JOptionPane.YES_OPTION) {
            try {
                sql = "DELETE FROM tb_pelanggan WHERE nama='" + txtNama.getText() + "'";
